    ...
    return (
        <>
            <div className="componentsHotel">
                ...
                <div className="hotelTitlePlaces">
                    <div className="hotelTitlePlacesContainer">
                ...
                <div className="footerHotelPage">
                    <Footer />
                </div>
                <div className="backImageHotels">
                    <img src={Fundo} className="backImageHotel" Alt="Arquitetura" />
                </div>
