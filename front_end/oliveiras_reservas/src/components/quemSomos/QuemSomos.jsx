        ...
        <>
            <div className="homeQuemSomosNos">
                ...
                <p>Aqui na nossa plataforma, estamos empenhados em fornecer um serviço excepcional a todos os nossos clientes,
                    oferecendo uma experiência personalizada e atendimento ao cliente de alta qualidade. Desde famílias em férias
                    até viajantes a negócios, acomodamos todas as necessidades de hospedagem. Queremos que nossos clientes se sintam
                    em casa em qualquer lugar do mundo.</p>
                <p>Nosso compromisso é oferecer uma estadia confortável e memorável, com opções que vão desde as acomodações mais
                    econômicas até as mais luxuosas. Trabalhamos diariamente para fornecer um serviço que supere as expectativas e ajude
                    a criar lembranças para toda a vida. Confie em nós para tornar suas viagens incríveis!</p>
            </div>
        </>
    )
}
